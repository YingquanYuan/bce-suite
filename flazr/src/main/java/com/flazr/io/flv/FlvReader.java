...
public class FlvReader implements RtmpReader {
    ...
    public static void main(String[] args) {
        FlvReader reader = new FlvReader("home/apps/vod/AnythingGoes.flv");
        while(reader.hasNext()) {
            RtmpMessage message = reader.next();
//            System.out.println(message.toString() + ", " + ChannelBuffers.hexDump(message.encode()));
            logger.info("{} {}", message, ChannelBuffers.hexDump(message.encode()));
        }
        reader.close();
    }
