...
public class RtmpClient {
    ...
    public static void main(String[] args) {
        System.out.println();
        // TODO 自己设置ClientOptions
        final ClientOptions options = new ClientOptions("rtmpe://localhost:1935/vod/ACDC.flv", "/home/robins/ACDC.flv");
//        if(!options.parseCli(args)) {
//            return;
//        }
//        options.setHost("127.0.0.1");
//        options.setPort(1935);
//        options.setSaveAs("/home/robins/ACDC.flv");
//        options.setRtmpe(true);
//        options.setStreamName("ACDC.flv");
